...
st.set_page_config(page_title="Twitter Airline Sentiment Analysis", page_icon="✈️", layout="centered")
...
st.write("Predict whether an airline-related tweet expresses Negative, Neutral, or Positive sentiment.")

tweet = st.text_area("Enter Tweet", height=150, placeholder="Example: I loved the customer service today!")
